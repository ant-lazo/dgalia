import { Component, Input, OnChanges, OnInit, SimpleChanges, Output, ViewChild, EventEmitter } from '@angular/core';
...
export class ListComponent implements OnChanges {
  ...
  @Output() selectedToRegister: EventEmitter<any> = new EventEmitter();
